...
(в нижнем регистре) строки sentence. Результат вывести на одной строке в алфавитном порядке,
...
save for a pocket of warmth in the darkest past, nothing of her subsists within the hollows and dells of memory, over 
...
myset = {word.strip(',.:;!?-()').lower() for word in sentence.split()}
print(*sorted(myset))
